...
def get_input_ids(message):
    ...
    print("input =", tokenizer.decode(input_ids, skip_special_tokens=False))
    return input_ids
...
for count in range(100):
    ...
    output_norm = [softmax(o) for o in outputs[0][0]]
    ...
    answer += [next_id]
    print("[decode]", tokenizer.decode(answer, skip_special_tokens=False), end="\n")
